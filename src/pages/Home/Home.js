...
const renderHomeContent = () => {
  ...
  <div class="welcome">
    ...
    <p>Fundado en 2023 por la Asociación El Vivero Cultural, el club de lectura de Los Palacios y Villafranca es un vibrante punto de encuentro para amantes de la lectura. Con un enfoque inclusivo, el club organiza discusiones mensuales sobre diversas obras literarias, promoviendo la diversidad de géneros y fomentando la participación activa de los miembros. El espacio sirve también como plataforma para eventos literarios que enriquecen la vida cultural de la comunidad.</p>
  </div>
  `;
